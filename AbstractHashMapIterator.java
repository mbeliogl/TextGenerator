 ...
 * The assumption here is that key/value pairs are stored as Entry types
 *
...
public abstract class AbstractHashMapIterator implements Iterator<Entry> {
    /**
     * @return true if there are still key/value pairs in the HashMap that still need to be accessed
     *         false otherwise
     */
   @Override
